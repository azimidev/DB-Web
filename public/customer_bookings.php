				...
				<tr>
					...
					<td>
						<?php if(!$booking["purchased"]): ?>
							...
							<?php else: ?>
								<a href="../includes/layouts/cancel_booking_item.php?id=<?php echo urldecode($booking["booking_id"]); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to cancel booking for <?php echo htmlentities(find_performance_by_id($booking["performance_id"])["performance_name"]); ?>?')">
									Cancel
								</a>&nbsp;&nbsp;&nbsp;&nbsp;
